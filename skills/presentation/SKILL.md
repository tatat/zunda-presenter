...
1. **Rewrite the text** — 「、」 inserts a pause, 「！」「？」 change intonation, 「〜」 lengthens vowels. Write Zundamon's surprise as 「えっ、」 never bare 「え、」 — the bare vowel synthesizes as a near-silent whisper (line-initial interjections like めたん's 「ええ、」 have the same failure mode; the synth script detects and repairs those automatically, but ずんだもん's bare 「え」 resists repair, so spell it 「えっ」). 「ううん」 is unsalvageable — measured across nine spellings and param combinations (ううん、/？/っ/ぅうん/うう、ん/intonation/speed…): head-rescue can raise its volume, but it keeps sounding like an assenting うん — a meaning bug, not a volume bug. Don't use it; めたん's soft denial lives in the reversal markers instead (それが、〜/そうじゃないの、〜/惜しいわね、〜 — see interaction.md, Interjection Openers, which prefers content over interjection openers across the board). 「いや」 stays out too — off-register in her mouth.
