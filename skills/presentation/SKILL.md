...
1. **Rewrite the text** — 「、」 inserts a pause, 「！」「？」 change intonation, 「〜」 lengthens vowels. Write Zundamon's surprise as 「えっ、」 never bare 「え、」 — the bare vowel synthesizes as a near-silent whisper (line-initial interjections like めたん's 「ええ、」 have the same failure mode; the synth script detects and repairs those automatically, but ずんだもん's bare 「え」 resists repair, so spell it 「えっ」). 「ううん」 has no such spelling fix — measured: ううん/ううんっ/いいえ all render soft (head ratio ~0.35) no matter the punctuation. Do NOT swap it for a louder word on audio grounds: its softness is part of めたん's register (「いや」 in particular sounds off in her mouth), and the synth script's head-rescue reliably lifts a ううん head into the audible range — keep the word, let the rescue carry it. Content denials (違うの/違うわ/逆よ) remain available where they read naturally, as a stylistic choice under the interjection budget, never as an audio workaround.
