...
1. **Rewrite the text** — 「、」 inserts a pause, 「！」「？」 change intonation, 「〜」 lengthens vowels. Write Zundamon's surprise as 「えっ、」 never bare 「え、」 — the bare vowel synthesizes as a near-silent whisper (line-initial interjections like めたん's 「ええ、」 have the same failure mode; the synth script detects and repairs those automatically, but ずんだもん's bare 「え」 resists repair, so spell it 「えっ」). 「ううん」 has no such spelling fix — measured: ううん/ううんっ/いいえ all render soft (head ratio ~0.35) no matter the punctuation, while 「いや、」 and content denials (違うの/違うわ/逆よ) render at full volume. Prefer the content denial (it also spends no interjection budget — interaction.md); a ううん that stays leans on the synth script's head-rescue.
